...
var exported_bool = exported_bool = {
  enforcing: {
...
var exported_inverted = exported_inverted = {
  bitwise : true,
  forin   : true,
  newcap  : true,
  plusplus: true,
...
var validNames = validNames = Object.keys(exported_val)
...
var unstableNames = unstableNames = Object.keys(unstable);

var exported_renamed = exported_renamed = {
  eqeq   : "eqeqeq",
  windows: "wsh",
  sloppy : "strict"
};

var exported_removed = exported_removed = {
  nomen: true,
  onevar: true,
  passfail: true,
  white: true,
...
var exported_noenforceall = exported_noenforceall = {
  varstmt: true,
  strict: true,
  regexpu: true
};

var exported_enforcing = {
 /**
      * This option prohibits the use of bitwise operators such as `^` (XOR),
      * `|` (OR) and others. Bitwise operators are very rare in JavaScript
      * programs and quite often `&` is simply a mistyped `&&`.
...
export { exported_enforcing as enforcing, exported_relaxing as relaxing, exported_environments as environments, exported_obsolete as obsolete };
var exported_maxlen = false;
var exported_indent = false;
var exported_maxerr = false;
var exported_predef = false;
var exported_globals = false;
var exported_quotmark = false;
var exported_scope = false;
var exported_maxstatements = false;
var exported_maxdepth = false;
var exported_maxparams = false;
var exported_maxcomplexity = false;
var exported_shadow = false;
var exported_strict = true;
var exported_unused = true;
var exported_latedef = false;
var exported_ignore = false;
var exported_ignoreDelimiters = false;
var exported_esversion = 5;
export { exported_scope as scope };
export { unstable };
var exported_bitwise = true;
var exported_forin = true;
var exported_newcap = true;
var exported_plusplus = true;
var exported_regexp = true;
var exported_undef = true;
var exported_eqeqeq = true;
var exported_strict = true;
export { exported_bitwise as bitwise, exported_forin as forin, exported_newcap as newcap, exported_plusplus as plusplus, exported_regexp as regexp, exported_undef as undef, exported_eqeqeq as eqeqeq, exported_strict as strict };
export { validNames };
export { unstableNames };
var exported_eqeq = "eqeqeq";
var exported_windows = "wsh";
var exported_sloppy = "strict";
export { exported_eqeq as eqeq, exported_windows as windows, exported_sloppy as sloppy };
var exported_nomen = true;
var exported_onevar = true;
var exported_passfail = true;
var exported_white = true;
var exported_gcl = true;
var exported_smarttabs = true;
var exported_trailing = true;
export { exported_nomen as nomen, exported_onevar as onevar, exported_passfail as passfail, exported_white as white, exported_gcl as gcl, exported_smarttabs as smarttabs, exported_trailing as trailing };
var exported_varstmt = true;
var exported_strict = true;
var exported_regexpu = true;
export { exported_varstmt as varstmt, exported_strict as strict, exported_regexpu as regexpu };
