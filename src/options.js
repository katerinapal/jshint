 ...
 */
var unstable = exports.unstable = {};;

// These are JSHint boolean options which are shared with JSLint
// where the definition in JSHint is opposite JSLint
var inverted = exports.inverted = {
  bitwise: true,
  forin: true,
  newcap: true,
  plusplus: true,
...
var validNames = exports.validNames = Object.keys(val).concat(Object.keys(bool.relaxing)).concat(Object.keys(bool.enforcing)).concat(Object.keys(bool.obsolete)).concat(Object.keys(bool.environments)).concat(["unstable"]);;

var unstableNames = exports.unstableNames = Object.keys(unstable);;

// These are JSHint boolean options which are shared with JSLint
// where the name has been changed but the effect is unchanged
var renamed = exports.renamed = {
  eqeq: "eqeqeq",
  windows: "wsh",
  sloppy: "strict"
};;
...
// `enforceall`.
var noenforceall = exports.noenforceall = {
  varstmt: true,
  strict: true,
  regexpu: true
};;
